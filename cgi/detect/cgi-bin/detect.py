...
def generate_data_set(url):
    ...
    # 6.Prefix_Suffix
    if re.findall(r"https?://[^\-]+-[^\-]+/" or r"http?://[^\-]+-[^\-]+/", url):
        data_set.append(-1)
    else:
        data_set.append(1)
...
result_label="Unable to find"
if prediction == -1:
    result_label="Might be a phishing website"
    result = '''Content-Type:text/html\n
        ...
        <head>
            ...
            <body style="background-color: #000;">
                <div style="padding-top:200px; color: #FF0000; font-size: 55px; font-weight: bold; text-align:center;">
                    <a href="%s" style="text-decoration: none;">
                        <div class="area">Warning</div>
                    </a>
                    <p>
                        %s<br>Might be Phishing!
                    </p>
                    <script>
